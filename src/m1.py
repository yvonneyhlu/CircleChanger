...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        d = rg.Point.get_distance_from(self.circle.center, point)
        return d
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        ind = random.randrange(0, len(self.colors))
        self.circle.fill_color = self.colors[ind]
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        for k in range(times_to_swell_or_shrink):
            if k % 2 == 0:
                ...
                n = -1
            self.swell_or_shrink_once(n*amount_to_swell_or_shrink)
            self.draw()
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        radius = rg.Point.get_distance_from(self.circle.center, other_circle_changer.circle.center)/2
        center = rg.Point((self.circle.center.x + other_circle_changer.circle.center.x)/2,
        ...
        return CircleChanger(new_circle.center.x, new_circle.center.y, new_circle.radius, 'red', newcolors)
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.or_color
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.n]
        self.n = self.n + 1
        if self.n == len(self.colors):
            self.n = 0
